...
const nonEmptyFileList = ['file1'] as unknown as FileList;
...
const FileListWithFileWithoutExtension = [{ name: 'image' }] as unknown as FileList;
const FileListWithPDFFile = [{ name: 'image.pdf' }] as unknown as FileList;
const FileListWithTXTFile = [{ name: 'image.txt' }] as unknown as FileList;
const FileListWithJPGImage = [{ name: 'image.jpg' }] as unknown as FileList;
const FileListWithPNGImage = [{ name: 'image.png' }] as unknown as FileList;
const FileListWithSVGImage = [{ name: 'image.svg' }] as unknown as FileList;
const FileListWithWEBPImage = [{ name: 'image.webp' }] as unknown as FileList;
